{ fetchzip }:
{
  "MobileFrontend" = fetchzip {
    url = "https://github.com/NixOS/nixos-wiki-infra/releases/download/MobileFrontend-REL1_44-6c41d8a.tar.gz/MobileFrontend-REL1_44-6c41d8a.tar.gz";
    hash = "sha256-n5b6Zxn6s5DU1BVpwbvlOsstMVVbULWRaIDOS/2A07I=";
  };
  "DarkMode" = fetchzip {
